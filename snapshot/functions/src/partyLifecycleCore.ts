...
/**
 * Arredondamento da DIVISÃO entre participantes — múltiplo de 25 com corte em
 * 10, espelhando `roundSplitTo25` do PartyPanel: para baixo quando faltam
 * MAIS de 10 unidades para o múltiplo superior; para cima quando faltam 10 ou
 * menos. Ex.: 389 -> 375 · 390 -> 400.
 */
...
export function settlementTotals(party: LifecycleParty): PartySettlementProjection["totals"] {
  ...
  return {
    ...
    splitValuePerMember: splitSlots.length > 0 ? roundSplitTo25(splitTotal / splitSlots.length) : 0,
