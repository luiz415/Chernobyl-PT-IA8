...
// serviceiro habilitado). As cenas usam o MODO DEMONSTRATIVO (demo: true):
// services fictícios preenchem o painel e o gate de acesso é ignorado
// durante o tutorial, para qualquer usuário conhecer a área por dentro.
// ============================================================================
  ...
  scenes: [
    {
      ...
      nav: NAV_MS,
      padding: 0,
      body: "\"Meus Services\" é onde você atua como [[sky:Serviceiro]]: oferece personagens de clientes como service para PTs e acompanha cada etapa.\n\nEsta área é exclusiva para usuários [[vip:VIP]] com o perfil de Serviceiro habilitado — durante o tutorial ela aparece preenchida com [[violet:dados demonstrativos]] para você conhecê-la por dentro.",
