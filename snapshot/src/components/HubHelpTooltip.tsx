...
const publicItems: HelpItem[] = [
  ...
  { title: "Services", text: "Cadastre e gerencie personagens de service com contato, link do personagem, valor combinado e quest. Envie o formulário público para que o seu cliente adicione o personagem dele optando por você ser o serviceiro, ou qualquer outro usuário. Para ser adicionado como um Serviceiro e poder ser escolhido por clientes, fale com um administrador.", tone: "sky" },
