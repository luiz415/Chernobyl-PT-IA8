...
export default function SuggestPartyModal({
  ...
  const vocationCounts = useMemo(() => {
    ...
    // IDs ocupados em outras PTs ativas — POR QUEST (mesma regra do
    // algoritmo): só bloqueia quem está em PT da MESMA Quest alvo.
    const busyIds = collectBusyIdsForQuest(allParties, effectivePtType, effectivePartyId);
  ...
  const serverCounts = useMemo(() => {
    ...
    // Mesma regra por Quest do quadro de vocações e do algoritmo.
    const busyIds = collectBusyIdsForQuest(allParties, effectivePtType, effectivePartyId);
