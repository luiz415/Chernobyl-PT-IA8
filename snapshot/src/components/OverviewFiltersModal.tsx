...
export default function OverviewFiltersModal({
  ...
  // A seleção de usuários ("Filtrar por Usuários Autorizados") foi movida para
  // o modal dedicado `UserFilterModal` (botão "Filtrar Usuários" no cabeçalho
  // da Visão Geral e no quadro "Última consulta" do Bazaar). A funcionalidade
  // continua a mesma — o estado unificado permanece em useOverviewFilters.
