...
export default function OverviewPanel({ characters, waitingList, activeParties }: Props) {
  ...
  // IDs já alocados em PTs ativas — POR QUEST: só ocupa quem está em PT da
  // MESMA Quest Alvo dos filtros. Com "all" (exige ambas), qualquer PT ativa
  // ocupa. Fonte única da regra em `collectBusyIdsForQuest`.
  const busyIds = useMemo(
    () => collectBusyIdsForQuest(activeParties, questFilter),
    [activeParties, questFilter],
  );
