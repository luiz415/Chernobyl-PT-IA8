...
interface Props {
  ...
  onCancel: () => void;
  /**
   * PERSONAGENS COM ITENS: trava o método de consulta (o seletor some do
   * modal e a preferência persistida das quests NÃO é alterada). A consulta
   * de itens usa exclusivamente o método novo — requisito da funcionalidade.
   * Ausente/undefined = comportamento atual, intacto.
   */
  forcedMethod?: BazaarMethod;
}
...
export default function BazaarBrowserModal({ open, onConfirm, onCancel, forcedMethod }: Props) {
